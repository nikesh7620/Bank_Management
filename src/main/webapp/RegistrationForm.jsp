...
<div class="sidebar" id="sidebar">
    <a href="<%=request.getContextPath()%>/LoadDashboardData"><i class="fas fa-home"></i>Dashboard</a>
    <a href="<%=request.getContextPath()%>/RegistrationForm.jsp?newClient=true"><i class="fas fa-user-plus"></i>Add New Client</a>
...
<div class="content" id="mainContent">
    <div class="form-container">        
        <div class="text-center mb-4">
            ...
            <h5 style="font-size: 18px; font-weight: 500;">Add New Client</h5>
        </div>

<form action="RegistrationForm" method="post" novalidate>
    <input type="hidden" name="redirectPage" value="RegistrationForm.jsp"/>
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        ...
        <div class="d-flex align-items-center gap-2">
            <!-- Custom select wrapper for country code -->
            <div class="custom-select-wrapper" style="width: 80px;">
                <select class="input-light" name="countryCode" required>
            ...
            <!-- Phone number input -->
            <input type="text" class="form-control input-light flex-grow-1" name="Mobnbr" autocomplete="off" minlength="10" maxlength="10"
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        ...
        <div class="custom-select-wrapper">
            <select class="input-light" name="idType" required>
                <option value="" disabled <%= session.getAttribute("idType") == null ? "selected" : "" %>>Select ID Type</option>
...
<script>
    ...
    // Sequential inline validation with email check
    ...
    form.addEventListener("submit", function(e) {
        ...
        const fields = [
            ...
            { selector: "[name='email']", errorId: "emailError", message: "Please enter valid email", condition: () => {
                const el = document.querySelector("[name='email']");
                return !el || !emailRegex.test(el.value.trim());
            }},
    ...
    if(idTypeField){
        idTypeField.addEventListener("change", () => {
            ...
            if(idNumberField) idNumberField.focus();
    ...
    // Optional: Use clearAndFocusNext helper for other fields if needed
    // Example: clearAndFocusNext("[name='address1']", "[name='address2']", "address1Error");
</script>
