...
<head>
    ...
    <style>
        ...
        .sidebar a:hover { background-color: #0b5ed7; } /* darker blue on hover */
...
<div class="sidebar" id="sidebar">
    <a href="<%=request.getContextPath()%>/BankDashBoard.jsp"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
    <a href="<%=request.getContextPath()%>/RegisterationForm.jsp"><i class="fas fa-user-plus"></i><span>Add New Client</span></a>
    <a href="<%=request.getContextPath()%>/DisplayClient.jsp"><i class="fas fa-users"></i><span>Display Client</span></a>
    <a href="<%=request.getContextPath()%>/login.jsp"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a>
</div>
    ...
    <form action="RegisterForm" method="post">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control input-light" name="Name"
                    autocomplete="off" minlength="1" maxlength="30" required
                    value="<%= session.getAttribute("Name") != null ? session.getAttribute("Name") : "" %>">
            </div>
            <div class="col-md-6">
                <label>Date of Birth *</label>
                <input type="date" class="form-control input-light" name="dob" 
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control input-light" name="Mobnbr"
            ...
            <div class="col-md-6">
                <label>Email *</label>
                <input type="email" class="form-control input-light" name="email"
                       autocomplete="off"
        ...
        <div class="mb-3">
            ...
            <input type="radio" name="gender" value="M" required 
                  <%= "M".equals(session.getAttribute("gender")) ? "checked" : "" %>> Male
            <input type="radio" name="gender" value="F" class="ms-3"
                  <%= "F".equals(session.getAttribute("gender")) ? "checked" : "" %>> Female
            <input type="radio" name="gender" value="T" class="ms-3"
                  <%= "T".equals(session.getAttribute("gender")) ? "checked" : "" %>> Transgender
        </div>

        <!-- Address Fields -->
        <div class="mb-3">
            <label>Address Line 1 *</label>
            <input type="text" class="form-control input-light" name="address1" 
                   autocomplete="off" minlength="1" maxlength="30" required
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control input-light" name="address2" 
                   autocomplete="off" minlength="0" maxlength="30"
                   value="<%= session.getAttribute("address2") != null ? session.getAttribute("address2") : "" %>">
        </div>

        <!-- Address Line 3 + Pincode + City -->
        <div class="row mb-3">
            <div class="col-md-4">
                <label>Address Line 3</label>
                <input type="text" class="form-control input-light" name="address3" 
                    autocomplete="off" minlength="0" maxlength="30"
                    value="<%= session.getAttribute("address3") != null ? session.getAttribute("address3") : "" %>">
            </div>
            <div class="col-md-4">
                <label>Pincode *</label>
                <input type="text" class="form-control input-light" name="pincode" 
                       autocomplete="off" minlength="6" maxlength="6" required
                       value="<%= session.getAttribute("pincode") != null ? session.getAttribute("pincode") : "" %>">
            </div>
            <div class="col-md-4">
                <label>City *</label>
                <input type="text" class="form-control input-light" name="city" 
                       autocomplete="off" minlength="1" maxlength="30" required
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label>State *</label>
                <input type="text" class="form-control input-light" name="state" 
                       autocomplete="off" minlength="1" maxlength="30" required
                       value="<%= session.getAttribute("state") != null ? session.getAttribute("state") : "" %>">
            </div>
            <div class="col-md-6">
                <label>Country *</label>
                <input type="text" class="form-control input-light" name="country" 
                       autocomplete="off" minlength="1" maxlength="30" required
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="radio" name="accType" value="Savings" required
                   <%= "Savings".equals(session.getAttribute("accType")) ? "checked" : "" %>> Savings
                <input type="radio" name="accType" value="Current" class="ms-3"
                   <%= "Current".equals(session.getAttribute("accType")) ? "checked" : "" %>> Current    
            </div>
            <div class="col-md-6">
                <label>Preferred Currency *</label><br>
                <input type="radio" name="currency" value="USD" required
                    onclick="toggleOtherCurrency()" 
                    <%= "USD".equals(session.getAttribute("currency")) ? "checked" : "" %>> USD
                <input type="radio" name="currency" value="INR" class="ms-3"
                    onclick="toggleOtherCurrency()"
                    <%= "INR".equals(session.getAttribute("currency")) ? "checked" : "" %>> INR
                <input type="radio" name="currency" value="OTH" class="ms-3"
                    onclick="toggleOtherCurrency()"
                    <%= "OTH".equals(session.getAttribute("currency")) ? "checked" : "" %>> Other:
                <input type="text" class="input-light ms-2" id="otherCurrencyInput"
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control input-light" name="idNumber" 
                       autocomplete="off" minlength="1" maxlength="20" required
        ...
        <% if (showModal) { %>
            <div class="modal fade show" id="responseModal" tabindex="-1" aria-labelledby="responseModalLabel" style="display: block;" aria-modal="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content text-center">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title w-100" id="responseModalLabel">Response Status</h5>
            ...
            <% session.removeAttribute("responseMessage"); session.removeAttribute("responseCode"); %>
        <% } %>
...
<script>
    ...
    function toggleOtherCurrency() {
        ...
        if (selectedCurrency === "OTH") {
            otherCurrencyInput.disabled = false;
            otherCurrencyInput.required = true;
        } else {
            otherCurrencyInput.disabled = true;
